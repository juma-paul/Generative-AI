...
#     """Centralized function for OpenAI API calls"""
#     response = client.chat.completions.create(
#         model="gpt-3.5-turbo",
#         messages=messages
#     )
...
#         subject = generate_openai_response([
...
#             {"role": "system", "content": "You are a customer support assistant for an electronics store."},
#             {"role": "user", "content": f"Summarize this comment: {comment}"}
#         ])

#         # Sentiment analysis
#         sentiment = generate_openai_response([
...
#         email_content = generate_openai_response([
#             {"role": "system", "content": "You are a customer support assistant for an electronics store."},
#             {"role": "user", "content": f"Generate an email in {language} based on the following: comment: '{comment}', summary: '{summary}', sentiment: '{sentiment}', subject: '{subject}'"}
#         ])
